...
save_steps = int(save_steps) if save_steps is not None else (10 if use_cpu else 100)
eval_steps = os.environ.get("EVAL_STEPS")
eval_steps = int(eval_steps) if eval_steps is not None else (10 if use_cpu else 100)
